  ...
  <el-container class="app-shell">
    <el-header class="topbar">
      ...
      <el-menu mode="horizontal" router :ellipsis="false" class="nav">
        ...
        <el-menu-item v-if="hasRole('USER')" index="/merchant/apply">商家入驻</el-menu-item>
        <el-menu-item v-if="hasRole('MERCHANT', 'SUPER_ADMIN')" index="/merchant">商家后台</el-menu-item>
        <el-menu-item v-if="hasRole('MERCHANT')" index="/merchant/reviews">评价管理</el-menu-item>
        <el-menu-item v-if="hasRole('MERCHANT')" index="/merchant/finance">财务结算</el-menu-item>
